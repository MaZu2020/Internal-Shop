...
TRANSLATIONS = {
    "title": {"de": "Interner Salt Store Shop", "en": "Internal Salt Store Shop", "fr": "Boutique interne Salt Store", "it": "Negozio interno Salt Store"},
...
st.markdown("""
    <style>
        .main-title {
            margin-top: -200px;   /* Titel weiter oben platzieren */
...
st.markdown('<h1 class="main-title">Internal SST Shop</h1>', unsafe_allow_html=True)
...
def display_products(product_data, email_mode=False):
    ...
    for index, row in product_data.iterrows():
        ...
        with col:
            ...
            # Bild und Benachrichtigungen anzeigen
