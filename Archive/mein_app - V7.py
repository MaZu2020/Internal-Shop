...
image_width = "150px"     # Breite des Bildes einstellen
image_height = "150px"    # Höhe des Bildes einstellen
...
def display_products(product_data, email_mode=False):
    ...
    for index, row in product_data.iterrows():
        ...
        with col:
            ...
            # Bemerkungen als Untertitel oder eine leere Zeile einfügen
            ...
            # Qty-Werte filtern (leere Werte entfernen)
            qty_options = [
                qty for qty in [row.get("Qty 1"), row.get("Qty 2"), row.get("Qty 3"), row.get("Qty 4")] 
                if not pd.isna(qty)
            ]
            ...
            if qty_options:
                ...
                st.markdown("<p style='font-size: small; color: gray;'>&nbsp;</p>", unsafe_allow_html=True)
